...
enum Model {
  qwen25_vl_7b(
    url:
        'https://huggingface.co/unsloth/Qwen2.5-VL-7B-Instruct-GGUF/blob/main/Qwen2.5-VL-7B-Instruct-IQ4_XS.gguf',
    filename: 'Qwen2.5-VL-7B-Instruct-IQ4_XS.gguf',
    displayName: 'Qwen 2.5 VL',
    size: '4.24GB',
    licenseUrl: 'https://huggingface.co/unsloth/Qwen2.5-VL-7B-Instruct-GGUF',
    needsAuth: false,
